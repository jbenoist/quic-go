...
func clearNetem() {
	if netemAvailable {
		status := execNetem("tc qdisc show dev lo")
...
var conditions = []networkCondition{
	...
	{Description: "10ms RTT", Command: "tc qdisc add dev lo root netem delay 5ms"},
	{Description: "50ms RTT", Command: "tc qdisc add dev lo root netem delay 25ms"},
	{Description: "100ms RTT", Command: "tc qdisc add dev lo root netem delay 50ms"},
	{Description: "400ms RTT", Command: "tc qdisc add dev lo root netem delay 200ms"},
	{Description: "10ms ± 1ms RTT", Command: "tc qdisc add dev lo root netem delay 5ms 1ms"},
	{Description: "50ms ± 5ms RTT", Command: "tc qdisc add dev lo root netem delay 25ms 5ms"},
	{Description: "10ms RTT, 1% packet loss", Command: "tc qdisc add dev lo root netem delay 5ms drop 1%"},
	{Description: "10ms RTT, 5% packet loss", Command: "tc qdisc add dev lo root netem delay 5ms drop 5%"},
	{Description: "100ms RTT, 1% packet loss", Command: "tc qdisc add dev lo root netem delay 50ms drop 1%"},
	{Description: "100ms RTT, 5% packet loss", Command: "tc qdisc add dev lo root netem delay 50ms drop 5%"},
}
